...
- Разметка данных:
    ...
    Данные были разбиты на чанки по следующей логике: в чанке не должно быть больших скачков (пропусков) кадров и должно распознаваться логически осмысленное движениею. В итоге получили следующие 4 чанка:
